...
from cdi.overrides.nflows_torchutils import searchsorted

"""
Provides faster unconstrained_rational_quadratic_spline implementation
"""
...
def unconstrained_rational_quadratic_spline(
    ...
    if tails == "linear":
        unnormalized_derivatives = F.pad(unnormalized_derivatives, pad=(1, 1),
                                         value=np.log(np.exp(1 - min_derivative) - 1))
